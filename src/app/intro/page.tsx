    ...
    return (
        <>
            ...
            <div className="w-full min-h-screen overflow-hidden top-0 absolute left-0">
                <div className="w-2xl fade-up0 opacity-0 absolute scale-30 lg:scale-50 rotate-4 -top-10 lg:top-10 -right-40 lg:right-0"><FlipCard card={mockupCards[1]} /></div>
                <div className="w-2xl fade-up1 opacity-0 absolute scale-30 lg:scale-50 rotate-12 top-90 lg:top-130 -left-40 lg:left-0"><FlipCard card={mockupCards[0]} /></div>
                <div className="w-2xl fade-up2 opacity-0 hidden lg:inline-block absolute scale-30 lg:scale-50 -rotate-8 top-130 left-1/2 -translate-x-1/2"><FlipCard card={mockupCards[2]} /></div>
                <div className="w-2xl fade-up3 opacity-0 absolute scale-30 lg:scale-50 -rotate-6 top-90 lg:top-130 -right-40 lg:right-0"><FlipCard card={mockupCards[3]} /></div>
                <div className="w-2xl fade-up4 opacity-0 absolute scale-30 lg:scale-50 -rotate-9 -top-10 lg:top-10 -left-40 lg:left-0"><FlipCard card={mockupCards[4]} /></div>
