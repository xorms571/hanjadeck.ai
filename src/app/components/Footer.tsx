...
export function Footer() {
  return (
    <footer className="bg-(--primary) text-white sm:mt-20">
        <div className="m-auto max-w-[1228px] flex flex-wrap gap-8 px-6 py-20">
          ...
          <div className="md:col-start-2 md:w-50">
        ...
        <div className="border-t border-zinc-300 px-6 py-10">
